...
-+----------()()---()------()()----()--()--()------()-----------------------/-\------------------------------
-+----------()-()--()()()--()--()--()--()--()()()--()()()-------------------|4|------------------------------
-+~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Version~Number~\~/~~~~~~~~Build~Number:~4.08.263
-+~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Edit~Number~:~263~~~~~
-============================================================================================================
*/
...
$_GLOBAL_LOCAL_SERVER_TIME_SWATCH_INTERNET							= date("B");
// Need to write more programming code in here for this later...
...
$_DB_Query_Kernel_Networking_Status_Security_Check_Blocked_Networks				= $_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_networking ORDER BY id ASC");
...
if ($_DB_Query_Kernel_Networking_Status_Security_Check_Blocked_Networks_IPA_String == "$_GLOBAL_REMOTE_SERVER_ADDRESS") {
	...
	header("Location: $_DB_Query_Kernel_Networking_Status_Security_Check_Blocked_Networks_Redirect_URL"); // Banished Internet Protocol Address Found - Redirect To Internet Protocol Address and Network Banishment Notification
	exit;
